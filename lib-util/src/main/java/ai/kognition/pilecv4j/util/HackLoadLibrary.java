...
public class HackLoadLibrary {
	private static final Logger LOGGER = LoggerFactory.getLogger(HackLoadLibrary.class);
	...
	static {
		...
		try (InputStream ocvVerIs = HackLoadLibrary.class.getClassLoader().getResourceAsStream(OCV_VERSION_PROPS)) {
