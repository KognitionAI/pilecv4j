...
public class ImageFile {
    ...
    *
    * <p>
    * This read method will fall back to OpenCV's codecs if the ImageIO codecs don't support the requested
    * file.
    * </p>
    *
    * <p>
    * It should be noted that, if the routing falls back to using ImageIO to open the file, then
    * a the data will be copied into the {@link BufferedImage} after it's loaded into a {@link CvMat}.
    * </p>
    *
    * @return a new {@link BufferedImage} constructed from the decoded file contents.
    */
   ...
   /**
    * See {@link ImageFile#readBufferedImageFromFile(String)}. ImageIO can handle file formats that allow
    * multiple images in a single file such as TIFF. The default is to read the first image but you can
    * ask for subsequent images by passing the imageNumber (starting at zero).
    *
    * <p>
    * If the imageNumber is more than the index of the last image in the file, then you'll get an
    ...
    * </p>
    *
    * @return a new {@link CvMat} constructed from the decoded file contents. <b>Note: The caller owns the
    *         CvMat returned</b>
    */
   ...
   /**
    * Converts an {@link Image} to a {@link BufferedImage} image in a really hacky way.
    */
