...
public:
   ...
   */
  static uint64_t createMatFromFrame(AVFrame *pFrame, SwsContext** colorCvrt, int32_t& isRgb, AVPixelFormat& lastFormatUsed, uint64_t existingMat, uint8_t** existingBuffer);
