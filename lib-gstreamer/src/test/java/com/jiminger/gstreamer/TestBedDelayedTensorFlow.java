...
public class TestBedDelayedTensorFlow {
   ...
   final static URI labelUri = new File(
         TestBedDelayedTensorFlow.class.getClassLoader().getResource("tensor/ssd_mobilenet_v1_coco_2017_11_17/mscoco_label_map.txt").getFile())
               .toURI();

   public static void main(final String[] args) throws Exception {

      final URI modelUri = new File(
            TestBedDelayedTensorFlow.class.getClassLoader().getResource(defaultSsdModel)
                  .getFile()).toURI();
      ...
      Gst.init(TestBedDelayedTensorFlow.class.getSimpleName(), args);
