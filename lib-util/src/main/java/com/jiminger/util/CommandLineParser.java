 ...
 *   For example:<P>
 *
 *   &nbsp&nbsp&nbsp&nbsp  java myclass -option value<P>
 *
 *   will allow the following:<P>
 *
 ...
 *                 -option3 value3<P>
 *
 *   will result in the following map:<P><P>
 *
 * <table BORDER="1"><tr><td>
 *            <B>name</B>       </td><td>       <B>value</B> </td></tr>
 *  <tr>
 *       <td>1) unoptionedvalue </td><td>           "true"   </td></tr><tr>
 *       <td>2) option1         </td><td>           value1   </td></tr><tr>
 *       <td>3) option2         </td><td>           "true"   </td></tr><tr>
 *       <td>4) option3         </td><td>           value3   </td></tr>
 * </table><P>
 *
...
public class CommandLineParser extends HashMap<String,String> {
   ...
   public CommandLineParser(String [] args, boolean addSystemParams)
   {
      noargs = null;
      parse(args);
   ...
   public int getTotalArgCount() { return argc_; }
   public int getOptionCount() { return size(); }
   public List<String> getNonOptionArgs() { return noargs; }
   ...
   {
      Set<Map.Entry<String, String>> s = entrySet();
      ...
      while(iter.hasNext())
      {
         Map.Entry<String,String> nv = iter.next();
         String key = (String)(nv.getKey());

         if (key != null)
         {
            ret = ret + " -" + key;
            String val = (String)(nv.getValue());
